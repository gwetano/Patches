...
class BrowserWindow extends electron.BrowserWindow {
    constructor(options) {
        ...
        if (os_1.isWindows10OrGreater && config) {
            ...
            __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").targetOpacity =
                __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").vibrnacyConfig.colors.a;
            __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").currentOpacity =
                __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").vibrnacyConfig.colors.a;
            __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").vibrnacyConfig.currentOpacity =
                __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").vibrnacyConfig.colors.a;
                    ...
                    if (os_1.isWindows10OrGreater && __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f")) {
                        ...
                        if (!__classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").opacityInterval)
                            __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").opacityInterval = setInterval(() => {
                                try {
                                    let colorDiff = (255 -
                                        __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").vibrnacyConfig
                                            .colors.a) /
                                        3.5;
                                    if (Math.abs(__classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").currentOpacity -
                                        __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f")
                                            .targetOpacity) < colorDiff) {
                                        __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").currentOpacity =
                                            __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").targetOpacity;
                                        if (__classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").opacityInterval)
                                            clearInterval(__classPrivateFieldGet(this, _BrowserWindow_winconfig, "f")
                                                .opacityInterval);
                                        __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").opacityInterval =
                                            undefined;
                                    }
                                    else if (__classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").currentOpacity >
                                        __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").targetOpacity)
                                        __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").currentOpacity -=
                                            colorDiff;
                                    else
    ...
    setVibrancy(options) {
        if (options) {
            ...
            (0, vibrancy_1._setVibrancy)(this);
            __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").vibrnacyConfig = (0, vibrancy_1.getConfigFromOptions)(undefined);
            __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").opacity = __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").vibrnacyConfig.colors.a;
            __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").targetOpacity =
                __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").vibrnacyConfig.colors.a;
            __classPrivateFieldGet(this, _BrowserWindow_winconfig, "f").currentOpacity =
...
_BrowserWindow_vibconfig = new WeakMap(), _BrowserWindow_winconfig = new WeakMap();
